...
сам джанго располагается в папке /home/e/eugenu/test/public_html/venv/lib/python2.7/site-packages

для начала надо переключиться на текущий virtualenv
заходим в папку с проектом

$ cd /home/e/eugenu/test/public_html
$ source venv/bin/activate

проверяем правильно ли определился путь до pip:
$ which pip
/home/e/eugenu/test/public_html/venv/bin/pip
...
$ pwd
/home/e/eugenu/test/public_html/HelloDjango/HelloDjango/tmp
$ touch restart.txt